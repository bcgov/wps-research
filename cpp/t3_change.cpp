...
int main(int argc, char ** argv){
  str sep("/");
  vector<str> channels;
  channels.push_back(str("T11.bin"));
  channels.push_back(str("T12_imag.bin"));
  channels.push_back(str("T12_real.bin"));
  channels.push_back(str("T13_imag.bin"));
  channels.push_back(str("T13_real.bin"));
  channels.push_back(str("T22.bin"));
  channels.push_back(str("T23_imag.bin"));
  channels.push_back(str("T23_real.bin"));
