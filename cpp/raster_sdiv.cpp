/* raster_sdiv.cpp: divide raster by scalar 20240530
...
int main(int argc, char ** argv){
  if(argc < 3) err("raster_sum.exe [raster cube] [scalar value to multiply]\n");
  ...
  str ofn(fn + str("_sdiv.bin"));  // output file name
