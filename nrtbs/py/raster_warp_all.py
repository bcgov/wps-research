...
parser.add_argument("BCwildfire", type=str, help="input raster folder")
parser.add_argument("small", type=str, help="output raster folder")
...
in_dir, out_dir = os.path.abspath(args.BCwildfire), os.path.abspath(args.small)
