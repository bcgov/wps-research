...
extern size_t * load_sub_i; // this is an array full of row indices for extracted stuff
extern size_t * load_sub_j; // this is an array full of col indices for extracted stuff
