* circle_100km.py -- generates a circular AOI
* load.py -- loads TIF imagery in present folder in QGis. Puts recent years' data on top
* annotate.py -- global annotation of TIF imagery. Output to shapefile.
