...
class ENVIImageAnnotator:
    def __init__(self, root):
        ...
        self.show_classification = False  # Track current view mode
    ...
    def classify(self):
        ...
        try:
            ...
            if width > screen_w or height > screen_h:
                ...
                # Clear classification overlay if exists
                ...
                self.toggle_button.config(state=tk.NORMAL, text="Show Image")
    ...
    def toggle_view(self):
        ...
        if self.show_classification:
            ...
            self.canvas.create_image(0, 0, anchor=tk.NW, image=self.classification_tkimg, tags="classification_overlay")
            self.status_var.set("Showing classification overlay.")
