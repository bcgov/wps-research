...
('SENTINEL2_L2A:/vsizip/S2B_MSIL2A_20230725T192909_N0509_R142_T10VEJ_20230725T231042.zip/S2B_MSIL2A_20230725T192909_N0509_R142_T10VEJ_20230725T231042.SAFE/MTD_MSIL2A.xml:TCI:EPSG_32610', 'True color image, UTM 10N')]
    ...
    desired_bands = ['B1', 'B2', 'B3', 'B4', 'B5', 'B6', 'B7', 'B8', 'B8A', 'B9', 'B11', 'B12', 'SCL'] # ['B5', 'B6', 'B7', 'B8A', 'B9', 
                    # 'B11', 'B12', 'B9'] # 'CLD']
    ...
    selected_bands = [sbs['B1'], sbs['B2'], sbs['B3'], sbs['B4'], sbs['B5'], sbs['B6'], sbs['B7'], sbs['B8'], sbs['B8A'], sbs['B9'], sbs['B11'], sbs['B12'], sbs['SCL']]  # reorder band selection
    ...
    for [band, m, sub_dataset] in selected_bands:
        ...
        if band_name not in ['B5', 'B6', 'B7', 'B8A', 'B11', 'B12', 'SCL']: # != "B12":
