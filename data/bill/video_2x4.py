...
class GIF():
    ...
    def __layout_and_run(
        ...
        self.title2 = ax2.set_title(f"No TITLE")

        self.im3 = ax3.imshow(temp, vmin=0, vmax=1)
        self.title3 = ax3.set_title(f"No TITLE")

        self.im4 = ax4.imshow(temp, vmin=0, vmax=1, cmap = 'gray')
        self.title4 = ax4.set_title(f"No TITLE")

        self.im5 = ax5.imshow(temp, vmin=0, vmax=1, cmap = 'gray')
        self.title5 = ax5.set_title(f"No TITLE")

        self.im6 = ax6.imshow(temp, vmin=0, vmax=1, cmap = 'gray')
        self.title6 = ax6.set_title(f"No TITLE")

        self.im7 = ax7.imshow(temp, vmin=0, vmax=1, cmap = 'gray')
        self.title7 = ax7.set_title(f"No TITLE")

        self.im8 = ax8.imshow(temp, vmin=0, vmax=1, cmap = 'gray')
        self.title8 = ax8.set_title(f"No TITLE")
...
if __name__ == "__main__":
    ...
    g = GIF(
        folder_name=folder,
        video_filename='./videos/test.mp4',
        ref_date = ref_date
    )
