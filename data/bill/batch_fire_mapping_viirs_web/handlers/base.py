...
class BaseHandler:
    ...
    ROUTES_GET = [
        ...
        (re.compile(
            r'^/api/fire/(?P<fire_numbe>[^/]+)/download_status$'),
         'handle_api_download_status'),
        (re.compile(
    ...
    ROUTES_POST = [
        ...
        # POST: the client uploads the two rendered frames, so this
        # takes a body even though the response is a download.
        (re.compile(
