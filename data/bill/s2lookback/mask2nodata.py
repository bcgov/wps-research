...
class MASK_TO_NODATA(LookBack):
    ...
    def _process_date(self, args):
        ...
        print(f"Processing {cur_date} (mask coverage: {coverage:.3f}) ...")
    ...
    def run(self):
        ...
        tasks = [(date) for i, date in enumerate(date_list)]
...
if __name__ == "__main__":
    ...
    cleaner = MASK_TO_NODATA(
        ...
        mask_dir=['C11659/wps_inference/abcd_cloud', 'C11659/shadow_20m'],
        output_dir='C11659/wps_inference/nodata_mrap',
        n_workers=12,
    )
