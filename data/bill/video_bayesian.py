...
class GIF():
    ...
    def __im3(
        ...
        expectations = lower_quantile(self.alpha, self.beta)
...
if __name__ == "__main__":
    ...
    g = GIF(
        folder_name=folder,
        video_filename= f'./videos/method=bayesian_refdate={ref_date}_showupdays=3_level=2+quantile_dnbr=78.mp4',
        ref_date = ref_date
    )
